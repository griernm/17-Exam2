...
class Triangle(object):
    ...
    def area(self):
        ...
        point1 = self.a
        point2 = self.b
        side1 = point1.distance_from(self.b)
        side2 = point1.distance_from(self.c)
        side3 = point2.distance_from(self.c)
    ...
    def get_largest_area(self):
        ...
        old_triangle = Triangle(self.a, self.b, self.c)
        area = self.area()
        while True:
            new_triangle = Triangle(self.a, self.b, self.c)
            if old_triangle.bigger_triangle(new_triangle) is False:
                break
            old_triangle = Triangle(self.a, self.b, self.c)
        return area
...
def run_test_return_doubled_triangle():
    ...
    expected_a = Point(20, 30)
    expected_b = Point(10, 8)
    expected_c = Point(160, 200)
    run_test_instance_variables(t2, expected_a, expected_b, expected_c)
